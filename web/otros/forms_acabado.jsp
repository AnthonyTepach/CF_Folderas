...
<ol>
    <li><input type="radio" name="dob" id="dobsimple" value="No" /><label for="dobsimple">&nbsp;No</label></li>
    <li><input type="radio" name="dob" id="dobsimple2" value="Diptico" /><label for="dobsimple2">&nbsp;Diptico</label></li>
    <li><input type="radio" name="dob" id="dobsimple3" value="Triptico" /><label for="dobsimple3">&nbsp;Triptico</label></li>
...
<ol>
    <li><input type="radio" name="tapa" id="taparollo" value="Si" /><label for="taparollo">&nbsp;Si</label></li>
    <li><input type="radio" name="tapa" id="taparollo1" value="No" /><label for="taparollo1">&nbsp;No</label></li>
